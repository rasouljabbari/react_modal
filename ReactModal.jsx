...
const ReactModal = memo((props) => {

    const [state, setState] = useState(false)
    const [copyState, setCopyState] = useState(false)
    const URLLink = "https://rasouljabbari.ir"
    ...
    return (
        <React.Fragment>
            <button 
                className='bg-blue-500 rounded-md text-white py-2 px-4 text-md hover:bg-blue-600 transition-all duration-300'
                onClick={()=>setState(true)}>Show modal</button>
